...
define config.save_directory = "Forever_and_Ever"
...
define config.window_icon = "mod_assets/DDLC_FaE_logo.png"
...
define config.layers = [ 'bg', 'master', 'transient', 'screens', 'overlay', 'front' ]
