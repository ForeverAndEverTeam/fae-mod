        ...
        fixed:
            vbox:
                if u.state == u.ERROR:
                    ...
                    text _("Forever & Ever is up to date.")
                ...
                if u.progress is not None:
                    null height gui._scale(10)
                    bar value u.progress range 1.0 left_bar Solid("#cc6699") right_bar Solid("#ffffff" if not fae_globals.dark_mode else "#13060d") thumb None
