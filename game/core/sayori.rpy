init 0 python:
    ...
    class Sayori(object):
        ...
        def _getAffectionStatus():
            ...
            i = 1
            for threshold in [
                fae_affection.AFF_THRESHOLD_LOVE,
                fae_affection.AFF_THRESHOLD_ENAMORED,
                fae_affection.AFF_THRESHOLD_AFFECTIONATE,
                fae_affection.AFF_THRESHOLD_HAPPY,
                fae_affection.AFF_THRESHOLD_NORMAL
            ]:


                if fae_affection._compareAffThresholds(persistent.affection, threshold) >= 0:
                    return fae_affection._AFF_STATE_ORDER[-i]

                # We can't go any further beyond ruined; return it
                if threshold == fae_affection.AFF_THRESHOLD_RUINED:
                    return fae_affection._AFF_STATE_ORDER[0]
        ...
        def _getAffectionTierName():
            ...
            elif affection_state == fae_affection.ENAMOURED:
                return "ENAMOURED"

            elif affection_state == fae_affection.AFFECTIONATE:
                return "AFFECTIONATE"

            elif affection_state == fae_affection.HAPPY:
                return "HAPPY"

            elif affection_state == fae_affection.NORMAL:
                return "NORMAL"

            elif affection_state == fae_affection.UPSET:
                return "UPSET"

            elif affection_state == fae_affection.DISTRESSED:
                return "DISTRESSED"

            elif affection_state == fae_affection.BROKEN:
                return "BROKEN"

            elif affection_state == fae_affection.RUINED:
                return "RUINED"
