...
style edited is default:
    font "mod_assets/fonts/gtw/gtw.ttf" #"gui/font/VerilySerifMono.otf"
    kerning 8
    outlines [(10, "#000", 0, 0)]
    xpos gui.text_xpos
    ...
    vbox:
        ...
        if not persistent.autoload or not main_menu:
            ...
            if _in_replay:
                ...
                if persistent.playthrough != 3 and persistent.playthrough < 5:
            ...
            pass #timer 1.75 action Start("autoload_yurikill")
...
style navigation_button_text:
    ...
    font "mod_assets/fonts/comicRelief/ComicRelief-Bold.ttf"
    color "#fff"
...
style game_menu_label_text:
    font "mod_assets/fonts/comicRelief/ComicRelief-Bold.ttf" #"gui/font/RifficFree-Bold.ttf"
    size gui.title_text_size
    color "#fff"
...
init python:
    def FileActionMod(name, page=None, **kwargs):
        ...
        #    return Show(screen="dialog", message="There's no point in saving anymore.\nDon't worry, I'm not going anywhere.", ok_action=Hide("dialog"))
            ...
            return Show(screen="dialog", message=_("Saving unable: save file may be corrupt."), ok_action=Hide("dialog"))
        else:
...
screen confirm(message, yes_action, no_action):
    ...
    frame:
        python:
            def remember_last_launch(td = get_now()):
                persistent.lastLaunch = td
        vbox:
            xalign .5
            yalign .5
            spacing 30
            ...
            hbox:
                ...
                if message == layout.QUIT:
                    textbutton _("Yes") action [Function(remember_last_launch), yes_action]
