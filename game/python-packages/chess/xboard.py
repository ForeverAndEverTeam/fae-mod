...
class Engine(object):
    ...
    def set_side_to_move(self, colour, async_callback=None):
        """
        Set the side to move, set the engine to move for the opposite side
        and exit force mode.

        :param colour: The desired side to move.

        :return: Nothing
        """
        self._assert_supports_feature("colours")
        side = chess.COLOUR_NAMES[colour]
