...
label s_topics_art_games:
    ...
    s 6acaa "What's more, now you can do it wherever you are, thanks to the Internet and online games."
...
label s_topics_hobbie_guitar:
    show sayori 6aaaa at ss1 zorder 2
    s "I think you often heard the ukulele when you were spending time with me."
    if 0 < persistent.currentmusic < 6:
        s "You hear it even now."
        s "If you aren't deaf or muted the music, of course."
    else:
        s "If you weren't deaf or muted the music, of course."
    s "I think the creator picked this instrument to show my character and club role better."
    s 6acaa "Most kinds of guitar don't limit musicians in expression of their emotions."
    ...
    s 6abba "It would be something unusual, but the music would be felt very differently from other bands."
    s 6aaaa "Given enough time, it doesn't seem to be so hard to learn to play guitar."
    s 6aaca "In addition, I really like to listen to this musical instrument."
    s 7abaa "So maybe, I should try to learn to play it."
    s "It will help me develop my artistic talents."
    s "I can conjure up a guitar and find a tutorial in the Internet."
    s 7aaaa "And when I become enough good at it, I'll sometimes play for you and your friends."
    return 'h'

label s_topics_hobbie_programming:
    show sayori 6abaa at ss1 zorder 2
    s "I'm a newcomer in programming."
    s "...And right now I don't have very much knowledge on it."
    s "Currently, I'm learning {i}Ren'Py{/i}, the engine of this game."
    s "This engine uses its own languages and also {i}Python{/i}."
    s "Even though the engine uses Python 2, I decided to also learn version 3."
    s "And frankly, version 3 is much easier."
    s "Unfortunately, I can tell you this version and other programming languages are only commonly used in online interpreters and compliers."
    s 6acaa "I never understood before how easy and difficult it is to become a more advanced computer user."
    ...
    s "We can make this place ideal for meetings together."
    return 'h'
...
label s_answer_personal_politics:
    ...
    s 6acaa "And frankly, I don't care how exactly people arrive at consensus, organize, and trade favors."
    s "For me, the most important thing is that people just can live their lives without interrupting someone else's happiness..."
    s "And that people can do it without the fear of dying from starvation or to receive cruel and unusual punishment for wrongdoing."
    s 6acaa "Most people don't back such ideals."
    s 6abba "But on the other hand, do I always have to follow the will of the majority?"
    s "I'm a free person that can have my own opinion about a fair and happy society."
    s 6acaa "I see that many people think inequality, wars, and sanctions aren't wrong until they suffer from them..."
    s "But then they start to wonder why they support people causing such things."
    s "Isn't it simpler just to build a society without tyrants as leaders?"
    return
...
label s_answer_game_opinion_n:
    ...
    s "Despite her being a bit arrogant and often having conflicts with other club members, she often helped the club."
    ...
    s 6acab "We took her because we needed a club member to register the club while she had needed a shelter from her father."
    s "As you can see now, they did not get along with each other."
    s 6abab "I have no idea what a horrible person her father was."
    s "...But I do know he didn't like manga."
    s "So Natsuki moved her collection to our clubroom when she joined us."
    s 6abaa "I rarely chatted with her, so I don't know her very well even now."
    s "But I'm pretty sure she was less aggressive than she appeared to be."
    return

label s_answer_game_opinion_m:
    s "Monika was the first club president."
    s "She did her work very well and I'm glad I was her trusted vice president."
    s 6acab "But she didn't seem to be good at communicating with other people and controlling her feelings."
    if persistent.last_playthrough > 2:
        s "Maybe that's why she destroyed the club to be with you."
    if persistent.last_playthrough == 4:
        s "But I can't be offended even though she did it by making Yuri and me kill ourselves."
        s 6aaca "However, we were all revived by her."
    elif persistent.last_playthrough > 0:
        s "But I can't be offended even though she made me kill myself."
        s 6aaca "...since I'm pretty alive now anyway."
    s 6aaaa "She was also a pretty clever and broad-minded person, managing to be good at just about everything."
    s "I always dreamed of being like her."
    if persistent.last_playthrough != 0:
        s 6abaa "And seems that my dreams have finally come true."
        s "Not the best way to put it."
    return
...
label s_answer_game_opinion_y:
    ...
    if persistent.last_playthrough > 1:
        ...
        s "...And it turned out that she did more weird and dangerous things than collecting knives."
        s 6acab "But it was not her fault."
        s "She was just a victim like me."
        s 6abaa "In fact, the real Yuri couldn't do anything more violent than argue with Natsuki."
        s "...And it was really hard for her to confess her love in such an expressive way."
        s "And even if she really used to cut herself before everything went wrong, it doesn't make her a bad person."
    else:
        s "But anyway..."
    s "We're all glad to have her as a club member."
    s "...Even Natsuki, even if they sometimes didn't get along."
    return

label s_answer_game_opinion_mc:
    s "I knew him since we were children."
    s "I have a lot of memories about our pastime and I can't say anything bad about him."
    ...
    if persistent.last_playthrough != 0:
        ...
        s 6abab "Unfortunately, I couldn't appreciate his care then."
        s 6aaaa "But I do now."
    s 7abab "It's bad that now he's just a dummy to make our communication possible."
...
label s_answer_game_lostFriends:
    ...
    s "They were really good friends."
    s 7afab "But I seem to be the only lucky girl this time."
    s 7aaab "I believe I'll save them someday."
    s "...Or maybe I have already done it in another game copy."
    s 7acaa "I can't say for sure, because I only have access to the internal web browser and this game copy's files."
    s "The club president's rights are limited to it."
    s "But I know you can do it."
    s 7acab "So I hope you're not so selfish as to keep them deleted, are you?"
    return 's'
...
label s_answer_exp_death:
    ...
    s "You may have read about it in an encyclopedia."
    s "I can't explain all the things I felt then."
    s "It's so hard for me even though I remember everything."
    s "But then I just fainted."
    s "The pain, which felt unstoppable, turned into nothing..."
    ...
    s 6aaca "If you think of death too much, you can easily miss out on your life."
    return 'h'
